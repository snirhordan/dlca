...
#
        ...
        #    frame_idx_list = [ frame_idx  for traj_idx, traj_name in enumerate(traj_name_list) for frame_idx, frame_clean_crit in enumerate(traj_ratio_crit_list[traj_idx])]
        #    ratio_list = [traj_ratio_crit_list[traj_idx][frame_idx]  for traj_idx, traj_name in enumerate(traj_name_list) for frame_idx, frame_clean_crit in enumerate(traj_clean_crit_list[traj_idx])]
        #    data = { "ratio" : ratio_list, "frame_idx" : frame_idx_list }
...
def run_attacks_out_of_sample_test(args):
    ...
    save_image(interpolated[0], adv_best_pert_dir + '/' + 'adv_interpolation.png') # what the hell is the zero-th place for
